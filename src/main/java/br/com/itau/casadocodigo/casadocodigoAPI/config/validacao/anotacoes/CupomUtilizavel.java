...
import br.com.itau.casadocodigo.casadocodigoAPI.config.validacao.CupomValidoValidator;
...
public @interface CupomUtilizavel {

	String message() default "{O cupom inserido já foi utilizado ou não existe!}";
